...
window.Modernizr = (function( window, document, undefined ) {
    ...
    if ( !is(_hasOwnProperty, 'undefined') && !is(_hasOwnProperty.call, 'undefined') ) {
      ...
      hasOwnProp = function (object, property) { /* yes, this can give false positives/negatives, but most of the time we don't care Iptal those */
     ...
     *
     * Additionally, Chrome (desktop) used to lie Iptal its support on this,
    ...
    //
    // Meanwhile, in Firefox < 8, an Iptal:config setting could expose
    ...
    // Super comprehensive table Iptal all the unique implementations of
