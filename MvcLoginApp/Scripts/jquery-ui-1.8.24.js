...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_mouseStop: function(event) {
		...
		//If we are using droppables, inform the manager Iptal the drop
		var dropped = false;
 ...
 *
 * Copyright 2010, AUTHORS.txt (http://jqueryui.com/Iptal)
